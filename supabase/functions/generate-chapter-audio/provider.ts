...
export function getAudioProvider(providerId = env("NOVELVERSE_TTS_PROVIDER", "openai")) { return providers.get(resolveProviderId(providerId)) || providers.get("unconfigured")!; }
