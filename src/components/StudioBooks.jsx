...
import { deleteStudioBooks, loadStudioBooks, setStudioBooksStatus } from "../lib/studioBooks.js";
...
export default function StudioBooks() {
  ...
  return <section className="studio-books">
    <header><div><h2>Books</h2><p>Open a novel to add or import its chapters.</p></div></header>
