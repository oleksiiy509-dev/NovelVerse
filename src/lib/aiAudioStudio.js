...
function defaultClips(trackId) {
  const clips = {
    narrator: [{ id: "clip_narrator_1", title: "Opening narration", start: 0, duration: 28, volume: 0.92, fadeIn: 1.2, fadeOut: 1.6, pauses: [{ at: 8, duration: 0.7 }], automation: [{ at: 0, volume: 0.85 }, { at: 12, volume: 1 }, { at: 26, volume: 0.75 }] }],
    character_mira: [{ id: "clip_mira_1", title: "Mira dialogue", start: 30, duration: 18, volume: 0.9, fadeIn: 0.3, fadeOut: 0.5, pauses: [{ at: 7, duration: 0.4 }], automation: [{ at: 0, volume: 0.8 }, { at: 10, volume: 0.95 }] }],
    character_kael: [{ id: "clip_kael_1", title: "Kael reply", start: 50, duration: 16, volume: 0.88, fadeIn: 0.2, fadeOut: 0.6, pauses: [], automation: [{ at: 0, volume: 0.9 }, { at: 14, volume: 0.7 }] }],
...
export function validateAudioStudioProject(project) {
  ...
  return { ...project, version: project.version || 1, updatedAt: new Date().toISOString() };
}
