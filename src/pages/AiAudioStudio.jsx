...
function AiAudioStudio() {
  ...
  useEffect(() => { setRenderJob(loadRenderJob({ projectId: project.id || project.projectId, novelId: project.novelId, chapterId: project.chapterId })); }, [project.id, project.projectId, project.novelId, project.chapterId]);
...
useEffect(() => {
  ...
  async function startRender(options = {}) {
    ...
    setRenderStats({ cacheHitCount: 0, failedClipCount: 0, startedAt: Date.now(), currentClip: null });
